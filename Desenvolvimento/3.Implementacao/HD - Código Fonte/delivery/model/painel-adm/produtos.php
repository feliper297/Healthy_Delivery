				...
				<div class="input-group input-group-sm">
					...
					<div class="form-group mr-2">
						...
						<select class="form-control d-none d-md-block form-control-sm" id="cbbuscar" name="cbbuscar">
							...
							$res = $pdo->prepare("SELECT * from categorias order by nome asc");
		...
		<div class="modal-content">
			<div class="modal-header">
				<?php if(@$_GET['funcao']=='editar'){
					...
					$id_reg = @$_GET['id'];
					$res = $pdo->prepare("SELECT * from produtos where id = '$id_reg'");
					$dados = $res->fetchAll(PDO::FETCH_ASSOC);
					$nome = $dados[0]['nome'];
						...
						<div class="form-group">
							...
							<select class="form-control" id="" name="categoria">
								...
								if(@$_GET['funcao'] == 'editar'){
									...
									$res_dado = $pdo->prepare("SELECT * from categorias where id = '$categoria'");
